...
/**
 * 构建代码自动生成工具类 参考官网 https://baomidou.com/
 *
 * mybatis-plus-boot-starter 版本3.5.2
 * mybatis-plus-generator 版本3.5.2
 * velocity-engine-core 版本2.3
 */
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/springboot-test?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","root")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.codeGen")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
